...
void Phonon::MPlayer::SeekStack::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        SeekStack *_t = static_cast<SeekStack *>(_o);
        switch (_id) {
        case 0: _t->popSeek(); break;
        case 1: _t->reconnectTickSignal(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData Phonon::MPlayer::SeekStack::staticMetaObjectExtraData = {
...
const QMetaObject Phonon::MPlayer::SeekStack::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Phonon__MPlayer__SeekStack,
      qt_meta_data_Phonon__MPlayer__SeekStack, &staticMetaObjectExtraData }
};
